...
?>
<?php
$metaGeneratorContent = 'Nicepage 3.9.3, nicepage.com';
$meta_generator = '';
...
<div id="page" class="site">
    ...
    <header class="u-clearfix u-custom-color-1 u-header u-header" id="sec-7dab">
  <div class="u-clearfix u-sheet u-sheet-1">
    <?php $logo = theme_get_logo(array(
      ...
      <img <?php if ($logo['svg']) {echo 'style="width:'.$logo['width'].'px"';} else {echo 'style="width:auto"';}?>src="<?php echo esc_url($logo['src']); ?>" class="u-logo-image u-logo-image-1" data-image-width="94">
    </a>
    <?php
            ob_start();
        ...
        <div class="u-black u-menu-overlay u-opacity u-opacity-70"></div>
            ...
            echo Theme_NavMenu::getMenuHtml(array(
                ...
                'menu' => array(
                    ...
                    'link_class' => 'u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-button-style u-nav-link u-text-active-custom-color-2 u-text-hover-grey-90 u-text-white',
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-fc65-17',
                ...
                'responsive_menu' => array(
                    ...
                    'link_style' => 'padding: 10px 0px;',
                    'submenu_class' => 'u-h-spacing-20 u-nav u-unstyled u-v-spacing-10 u-block-fc65-18',
                    'submenu_item_class' => 'u-nav-item',
